...
def test_future_close_and_return_calculation():
    ...
    result = LabelGenerator().generate_labels(df, prediction_horizon_bars=2, buy_threshold_pct=0.5, sell_threshold_pct=-0.5)
...
def test_buy_sell_hold_labels():
    ...
    result = LabelGenerator().generate_labels(df, prediction_horizon_bars=1, buy_threshold_pct=0.5, sell_threshold_pct=-0.5)
